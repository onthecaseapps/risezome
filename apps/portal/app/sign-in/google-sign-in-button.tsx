  ...
  return (
    <div className="space-y-3">
      <button
        ...
        disabled={loading}
        className="flex w-full items-center justify-center gap-3 rounded-lg border border-border bg-card px-4 py-3 text-sm font-medium text-fg shadow-sm transition-colors hover:border-accent hover:bg-card/80 disabled:opacity-60"
      >
        <GoogleGlyph />
...
/**
 * Multicolor Google brand G rendered directly on the surface (no white
 * badge). Matches the mockup's button treatment — dark/surface button
 * with the multicolor G floating against the dark background.
 */
