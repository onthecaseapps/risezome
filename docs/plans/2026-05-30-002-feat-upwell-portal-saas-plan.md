...
**Files:**
- Create: `apps/bot-worker/package.json`, `tsconfig.json`, `tsconfig.build.json`, `vitest.config.ts`, `README.md` (local-run instructions including Cloudflare Tunnel setup), `cloudflared.config.yml` (named-tunnel config template).
